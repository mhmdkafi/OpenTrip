...
import { Mail, Lock, Building, User, Phone, UserPlus } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        router.push(data.requiresEmailConfirmation ? "/login?registered=1" : "/dashboard");
        router.refresh();
      } else {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 mt-2">Daftarkan bisnis open trip Anda</p>
          </div>
