...
export function ProfileDialog({profile,business,onSave,onClose}:{profile:AdminProfile;business:string;onSave:(profile:AdminProfile)=>Promise<void>;onClose:()=>void}) {
